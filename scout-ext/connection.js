...
class ExtensionWalletManager {
    ...
    loadWalletBridge() {
        ...
        if (!iframe) {
          ...
          // Load the wallet bridge from extension resources (using enhanced version)
        const extensionBridgeUrl = chrome.runtime.getURL('wallet-bridge.html');
        console.log('📍 Loading ENHANCED wallet bridge from:', extensionBridgeUrl);
        console.log('🚀 Bridge will use AGGRESSIVE wallet detection methods');
